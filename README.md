...
- Para explorar la solucion se debe:
    ...
    5. Explorar la solucion usando un cliente de pruebas de api (ej: Postman) o bien un navegador de preferencia guiandose con la coleccion postman que mas abajo se anexa.
